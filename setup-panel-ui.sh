...
www-data ALL=(root) NOPASSWD: /usr/local/bin/vpn-control.sh, /usr/local/bin/ovpn-user-manage.sh, /usr/local/bin/ovpn-make-profile.sh, /usr/local/bin/ovpn-kill-user.sh
SUDO
