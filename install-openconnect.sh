...
apt-get install -y ocserv gnutls-bin apache2 php libapache2-mod-php php-cli php-sqlite3 sqlite3 curl openssl sudo iptables iproute2 ca-certificates >/dev/null
